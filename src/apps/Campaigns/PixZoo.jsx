...
export function Campaign() {
	...
	return (
		<Box>
			<Box
				sx={{
					background: 'url(/assets/campaigns/pixzoo/bg.jpg)',
					...
					<Grid container spacing={2}>
						...
						<Grid item sx={{ textAlign: 'right' }} xs={12} md={7}>
							<Box sx={{ position: 'absolute', marginTop: 12, right: 12 }}>
							  <img width="640px" src={'/assets/campaigns/pixzoo/islandfloat.png'} alt={'Pixzoo Island'} />
							</Box>
						</Grid>
					</Grid>
				</Container>
...
function Description() {
	return (
		<Grid container spacing={4}>
			<Grid item xs={12}>
				<Typography variant="h4">COLLECT POOP &</Typography>
				<Typography variant="h2">BUILD YOUR ISLAND</Typography>
			</Grid>
			...
			<Grid item xs={12}>
				<img height='100%' width="100%" src="/assets/campaigns/pixzoo/androidmockreal.png"/>
			</Grid>
