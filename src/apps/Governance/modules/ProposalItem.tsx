...
import { Box, Button, Stack, Typography, Chip, useTheme, Grid } from 'src/components'
...
console.log(proposal)
    ...
    display="flex">
						<Box
							...
							sx={{ cursor: 'pointer' }}
						>
							<Typography sx={{ fontSize: '0.75rem', opacity: 0.3 }} variant="body1">{body.name}</Typography>
    ...
    display="flex">
						<Box sx={{ verticalAlign: 'middle'}} marginLeft="auto" marginRight={1} display="flex" alignItems="center">
							<Chip
								sx={{
    ...
    display="flex">
						<Box sx={{ verticalAlign: 'middle'}}>
							<Button size="large" onClick={() => navigate(`/app/governance/${proposalId}`)}>
