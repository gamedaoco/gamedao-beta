				...
				<Grid spacing={1} columns={16}>
					...
					<Grid container direction="Row" mb={4}>
						...
						<Grid xs={16} md={4} mb={4}>
							<Typography variant="h3" sx={{ fontSize:'1.5em', mb:'1em'}}>About</Typography>
							<Link href="https://blog.gamedao.co/the-gamedao-pinky-paper-8dcda7f2e1ca">
								short paper
							</Link>
							<Link href="https://blog.gamedao.co">
								blog
							</Link>
							...
							<br />
							<Link href="https://gamedao.co">
								gamedao.co
							</Link>

						</Grid>
						<Grid xs={16} md={4} mb={4}>
							<Typography variant="h3" sx={{ fontSize:'1.5em', mb:'1em'}}>How we build</Typography>
						...
						<Grid xs={16} md={8} mb={4}>
							<Typography variant="h3" sx={{ fontSize:'1.5em', mb:'1em'}}>GameDAO. For the Creator and Player Economy.</Typography>
							<Typography variant="body" sx={{fontSize:'1.25em'}}>
								<p>
