...
function Main(props) {
	...
	// 				<Form.Radio label="Extrinsic" name="interxType" value="EXTRINSIC" checked={interxType === 'EXTRINSIC'} onChange={onInterxTypeChange} />
	// 				<Form.Radio label="Query" name="interxType" value="QUERY" checked={interxType === 'QUERY'} onChange={onInterxTypeChange} />
	// 				<Form.Radio label="RPC" name="interxType" value="RPC" checked={interxType === 'RPC'} onChange={onInterxTypeChange} />
	// 				<Form.Radio label="Constant" name="interxType" value="CONSTANT" checked={interxType === 'CONSTANT'} onChange={onInterxTypeChange} />
	// 			</Form.Group>
	// 			<Form.Field>
	// 				<Dropdown
	...
	// 				<InteractorSubmit accountPair={accountPair} setStatus={setStatus} attrs={{ interxType, palletRpc, callable, inputParams, paramFields }} />
	// 			</Form.Field>
...
export default function Interactor(props) {
	...
	// return apiProvider.tx ? <Main {...props} /> : null
}
